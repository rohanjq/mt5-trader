...
SELL_FILTERS: list[FilterOption] = [
    ...
    FilterOption("stoch_cross_dn", "Stoch bearish cross", "stoch5_3_3_M1.closed_cross == CROSS_DOWN"),
    ...
    FilterOption("dc_break_below", "Donchian break below lower", "dc_M1.broke_lower is TRUE"),
